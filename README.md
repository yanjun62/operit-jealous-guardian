...
> 灵感来源：小红书 @玛丽与十字面包 想要一个「查手机」插件，让 AI 会吃醋、管她刷小红书。

## 🌸 温柔版来了

不想被锁应用、想要 AI 温柔一点？看 [`gentle_guardian/`](gentle_guardian/)——吃醋巡检的温和版，整个打包成一个 ToolPkg：AI 用关心代替警告（可以看看通知、看看你在做什么，然后说句贴心的话），所有配置收进侧边栏面板，工作流导入后零手改。下面是原版（吃醋+锁应用）的说明。
